...
function init() {
  ...
  const texture01 = loader.load('<?php echo get_template_directory_uri();?>/img/img_01.jpg');
  const texture02 = loader.load('<?php echo get_template_directory_uri();?>/img/img_02.jpg');
  const texture03 = loader.load('<?php echo get_template_directory_uri();?>/img/img_03.jpg');
  const texture04 = loader.load('<?php echo get_template_directory_uri();?>/img/img_04.jpg');
  const texture05 = loader.load('<?php echo get_template_directory_uri();?>/img/img_05.jpg');
  ...
  // KV背景の画像切り替え
  const backgrounds = [
    "<?php echo get_template_directory_uri();?>/img/img_05.jpg",
    "<?php echo get_template_directory_uri();?>/img/img_01.jpg",
    "<?php echo get_template_directory_uri();?>/img/img_02.jpg",
    "<?php echo get_template_directory_uri();?>/img/img_03.jpg",
    "<?php echo get_template_directory_uri();?>/img/img_04.jpg",
  ]
