...
class Main {
    ...
    _scrollInit() {
        //このプライベートは_paceDoneで渡される。
        //setメソッドの引数に渡る。代入という形で特殊
        ...
        this.observers = new ScrollObserver('.swiper-container', this._toggleSlideAnimation.bind(this), {once: false});//onceをfalseにすることによって継続的に監視。
